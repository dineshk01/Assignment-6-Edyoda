...
function creategridcard(card_image,card_alt,card_title,card_desc)
  {


var gridcard =document.createElement('div');
gridcard.classList.add('gridItem');
...
videoimage.classList.add('cardImg');

videoimage.src=card_image;
videoimage.alt=card_alt;
Divcard.appendChild(videoimage);


var carddescription =document.createElement('div');
carddescription.classList.add('cardContent');
...
{
    var videocard=creategridcard(cards[i].imgUrl,cards[i].imgAlt,cards[i].header,cards[i].description);
